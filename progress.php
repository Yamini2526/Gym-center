...
<body>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-center">
                        ...
                        <h5 id="modalUser  Name">John Doe</h5>
                        <p class="text-muted" id="modalUser  Email">johndoe@example.com</p>
                        <div class="text-start px-4">
                            <p><strong>Username:</strong> <span id="modalUser  Username">johndoe123</span></p>
                            <p><strong>Date of Birth:</strong> <span id="modalUser  DOB">01 Jan 1990</span></p>
                            <p><strong>Phone Number:</strong> <span id="modalUser  Phone">+1234567890</span></p>
                            <p><strong>Height:</strong> <span id="modalUser  Height">5'9"</span></p>
                            <p><strong>Weight:</strong> <span id="modalUser  Weight">70 kg</span></p>
                        </div> 
                        <button class="btn btn-outline-danger mt-3 w-100" onclick="logoutUser  ()">Logout</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <input name="" id="update-progress-but" class="btn btn-primary float-end m-2" type="button" value="Update progress" onclick="updateprogress()"/>
                ...
                <div class="mb-3">
                    ...
                    <div id="workout-list">
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Abs">Abs (5 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Triceps">Triceps (6 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Leg">Leg (8 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Biceps">Biceps (7 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="push-ups">Pushups (9 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="planks">Planks (10 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="squats">Squats (10 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Deadlifts">Deadlifts (10 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Benchpress">Benchpress (15 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Jumpsquats">Jumpsquats (11 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Sidesquats">Sidesquats (10 cal per set)</label>
                        ...
                        <div class="form-check">
                            ...
                            <label class="form-check-label" for="Burpees">Burpees (17 cal per set)</label>
                        ...
                        <div class="form-check d-none">
                            <input type="number" id="workoutsinp" name="workouts" class="form-control workout-input" placeholder="Sets/Reps" min="0" style="display: none;">
                        </div> 
                    </div>
                </div>
                <div class="mb-3">
        ...
        <table class="table table-bordered">
            ...
            <tbody id="history">
                ...
                <tr>
                    <td><?=$row['Date'] ?></td>
                    <td><?=$row['weight'] ?></td>
                    <td><?= $cur_weight / ($heightInMeters * $heightInMeters) ?></td>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            function toggleInputVisibility() {
                document.querySelectorAll('.workout-checkbox').forEach(checkbox => {
                    let relatedInput = document.getElementById(checkbox.id + "Count");
                    if (checkbox.checked) {
            ...
            function getCheckedExercises() {
                ...
                document.querySelectorAll('.workout-checkbox:checked').forEach(checkbox => {
                    // Extract the exercise name from the label
                    let exerciseName = checkbox.nextElementSibling.innerText.split(" (")[0];
                    workoutDetails.push(exerciseName); // Add the exercise name to the array
                });

                return workoutDetails.join(", "); // Join all details into a single string separated by commas
            }

            // Event delegation for checkboxes
            document.getElementById("workout-list").addEventListener("change", function (event) {
            ...
            document.getElementById("workout-list").addEventListener("input", function (event) {
                if (event.target.classList.contains("workout-input")) {
                    calculateCalories();
                    // Log checked exercises to the console on input
                    let workoutDetails = getCheckedExercises();
                    document.getElementById('workouts').value=workoutDetails;
                    console.log("Checked Exercises: ", workoutDetails);
                }
            });
